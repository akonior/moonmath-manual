...
\hypersetup{
    pdftitle={The MoonMath Manual},
    pdfauthor={Least Authority}
}
...
\hypersetup{
	...
	linkcolor=la-black-med, %the color of document-internal links
	filecolor=la-black-med, %the color of links to local files (probably won't be used, but added for completeness' sake)
	urlcolor=la-black-med, %the color of links to web sites
	citecolor=la-black-med, %the color of links to the reference list
}
